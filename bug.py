...
class BigBug(Bug):
    ...
    def __init__(self, x, y, speed, health, max_health, bug_size, rect_x, rect_y, name):
        ...
        self.__big_bug_images_attack = [pygame.transform.scale(pygame.image.load(os.path.join("assets", "Monster_2","attack", f"{i}.png")), (150, 150)) for i in range(0, 8)]
    ...
    def draw_attack(self, screen, dt):
        return super().draw_attack(screen, dt, self.__big_bug_images_attack)
